        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant overflow-hidden">
            ...
            <div className="divide-y divide-outline-variant/50">
              {/* ⚡ Bolt: A lista do Ranking agora utiliza virtualização (react-window).
                 Impacto esperado: Melhoria na performance de renderização do DOM e tempo de bloqueio (TBT) em ligas com muitos jogadores,
                 renderizando apenas os itens visíveis na tela. */}
                    ...
                    {({ height, width }) => (
                      ...
                      >
                        {({ index, style }) => {
                          ...
                          return (
                            <div style={style} key={jogador.id} className="flex items-center px-4 py-3 hover:bg-surface-container hover:shadow-sm hover:-translate-y-[1px] transition-all duration-200 border-b border-outline-variant/50">
                              ...
                              <div className="flex-1 flex items-center gap-3">
                                ...
                                <div className="flex flex-col">
                                  <span className="font-headline-md text-body-md text-on-surface truncate pr-2" title={jogador.nome}>{jogador.nome}</span>
