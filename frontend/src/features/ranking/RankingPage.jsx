...
function PremioCard({ titulo, icone, imgSrc, subtitulo, pontos, estilo, vencedores }) {
  return (
    <div className={`bento-card bg-gradient-to-br ${estilo} border border-outline/10 p-6 flex flex-col justify-between min-h-[180px] group transition-all duration-300 hover:-translate-y-1 hover:shadow-ambient-2`}>
      <div>
